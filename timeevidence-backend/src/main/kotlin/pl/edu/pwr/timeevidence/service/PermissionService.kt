...
class PermissionService (private val permissionRepository: PermissionRepository) {
    ...
    //fun getPermissions(criteria: EntityCriteria<Permission>) =
    //    PagedResponse(permissionRepository.findAll(criteria.specification, criteria.paging!!).map { PermissionResponse(it) })
